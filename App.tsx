...
export default function App() {
  ...
  const [chatRecipient, setChatRecipient] = useState<string>(''); // '' = public
        ...
        <div className="flex items-center gap-4">
          <div>
            <h1 className="text-lg font-bold tracking-tight text-slate-100 leading-tight">
              GWM Vehicle Traceability System - VTS
            </h1>
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3 pl-6 border-l border-slate-700">
            <div className="text-right hidden md:block cursor-pointer" onClick={() => setIsProfileOpen(true)}>
              ...
              <p className="text-xs text-slate-400">{currentUser.role} (用户)</p>
            </div>
            <div 
      ...
      <main className="flex-1 overflow-auto relative">
         {currentView === 'DASHBOARD' && (
           <div className="absolute inset-0 z-0">
             <img 
               src="https://wallpapers.com/images/featured/haval-089etj9zc9genyvy.jpg" 
        ...
        {isChatOpen && (
          <div className="bg-slate-900 border border-slate-700 rounded-xl shadow-2xl w-80 h-96 mb-4 flex flex-col pointer-events-auto overflow-hidden">
             ...
             <div className="flex-1 overflow-auto p-3 space-y-3 bg-slate-900">
                {chatMessages.length === 0 && <div className="text-center text-slate-500 text-xs mt-10">No messages yet.</div>}
           ...
           <div className="bg-slate-900 border border-slate-700 rounded-xl p-6 w-96 shadow-2xl">
              ...
              <div className="space-y-4">
                 <div className="flex flex-col items-center mb-4">
                    ...
                    <p className="text-xs text-slate-500">Paste URL below to update photo</p>
                 </div>
                 ...
                 <div>
                    <label className="block text-xs text-slate-400 mb-1">Photo URL (Cloud)</label>
                    <input 
                      className="w-full bg-slate-800 p-2 rounded border border-slate-600"
                 ...
                 <button 
                    ...
                    className="w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded font-bold flex items-center justify-center gap-2"
                 >
